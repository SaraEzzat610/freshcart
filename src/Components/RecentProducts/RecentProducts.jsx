...
export default function RecentProducts({ product }) {
  ...
  return (
    <>
      <div className="product hover:border rounded-lg border-emerald-500 hover:shadow-lg hover:shadow-green-900  transform transition-transform overflow-hidden  w-72 sm:w-5/12 md:w-1/3 lg:w-1/4 xl:w-1/6 p-6 m-5">
        <div>
