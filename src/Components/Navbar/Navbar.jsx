  ...
  return (
    <>
      <nav className="bg-[#f8f9fa]  fixed w-full z-20 top-0 start-0 border-b border-gray-200 text-white">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-center md:justify-between gap-4 mx-auto p-4">
          ...
          <div className="flex items-center md:order-2 space-x-3 md:space-x-4 rtl:space-x-reverse">
            {localStorage.getItem("userToken") ? (
              <>
                ...
                >
                  <i className="fa-solid fa-arrow-right-from-bracket fa-rotate-180 text-red-500"></i>{" "}
              ...
              <>
                  ...
                  <Link to="/register" className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Register</Link>
              </>
            )}
          </div>
          <div
